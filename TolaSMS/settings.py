# Django settings for TolaSMS project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a TolaSMS directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'TolaSMS')
...
SECRET_KEY = '!$)r$^u3(!@gld2ot(93rj0ayi!0i_3z+lvde&f5_7f((cgtll'
...
ROOT_URLCONF = 'TolaSMS.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'TolaSMS.wsgi.application'
...
INSTALLED_BACKENDS = {
    ...
    "my-tropo-backend": {
        ...
        'config': {
            ...
            'messaging_token': '65484d52446f686c6b665a78687678424272614e48764e724f714a78667a76734c71507268646f776a697344',
    ...
    "twilio-backend": {
        ...
        'config': {
            'account_sid': 'AC1d28a1d60f0f7ec445cfffd2dcbdb3c3',  # (required)
            'auth_token': 'be8c39c5fb7881e95cd9773d5fdcf242',  # (required)
            'number': '+18058708909',  # your Twilio phone number (required)
